...
def check_symbol(sym: str, max_retries: int = 3) -> dict:
    ...
    level_type = "support" if nearest < last_close else "resistance"
...
def main():
    ...
    fields = ["symbol", "last_date", "last_close", "nearest_level",
              "nearest_level_type", "dist_pct", "days_to_exp", "is_alert", "status"]
